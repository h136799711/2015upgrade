...
(1, 'WEBSITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '博也在线升级系统', 0),
(2, 'WEBSITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, '博也在线升级系统', 1),
(3, 'WEBSITE_KEYWORDS', 0, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '博也在线升级系统', 0),
(9, 'CONFIG_TYPE_LIST', 3, '配置类型列表', 4, '', '主要用于数据解析和页面表单的生成', 1378898976, 1379235348, 1, '0:数字\r\n1:字符\r\n2:文本\r\n3:数组\r\n4:枚举\r\n5:图片地址', 2),
(10, 'WEBSITE_ICP', 1, '网站备案号', 1, '', '设置在网站底部显示的备案号，如“沪ICP备12007941号-2', 1378900335, 1379235859, 1, '浙ICP备14029991号', 9),
...
(39, 'WEBSITE_OWNER', 1, '网站拥有者', 1, '', '当前网站拥有者或是开发者', 1419415563, 1419415563, 1, '博也网络科技有限公司', 1),
...
(37, 'SHOW_PAGE_TRACE', 4, '是否显示页面Trace', 4, '0:关闭\r\n1:开启', '是否显示页面Trace信息', 1387165685, 1432708082, 1, '0', 1),
(42, 'UCENTER_PLATFORM', 1, '管理平台名称', 1, '', '', 1420006808, 1420006808, 1, '博也网络科技', 1),
...
(46, 'SITE_URL', 1, '站点URL地址', 1, '', '末尾不包含/符号，例如：http://localhost', 1426478195, 1426478195, 1, 'http://localhost/github/2015upgrade', 4);
...
(184, '应用列表', 183, 0, 'Ucenter/UcenterApp/index', 0, '应用列表', '', 0, 1),
(183, '应用管理', 182, 0, '#', 0, '', '', 0, 1),
(182, '应用', 0, 0, 'Ucenter/UcenterApp/index', 0, '应用配置', '', 0, 1),
...
(175, '用户', 0, 1, 'Ucenter/Index/index', 1, '', '', 0, 1),
...
(245, '用户', 0, 0, 'Ucenter/MemberInfo/index', 1, '用户信息，学校信息，学生信息、家长信息、教师信息、', '', 0, 1),
(246, '学生模块', 245, 0, '#', 0, '', '', 0, 1),
(247, '教师模块', 245, 0, '#', 0, '', '', 0, 1),
(248, '家长模块', 245, 0, '#', 0, '', '', 0, 1),
(249, '内容管理', 0, 0, 'Ucenter/Post/index', 1, '', '', 0, 1),
(250, '文章模块', 249, 0, '#', 0, '', '', 0, 1),
(251, '文章发布', 250, 0, 'Ucenter/Post/add', 0, '', '', 0, 1),
(252, '文章管理', 250, 0, 'Ucenter/Post/index', 0, '', '', 0, 1),
(214, '数据字典', 165, 0, 'Ucenter/Datatree/index', 0, '', '', 0, 1);
...
INSERT INTO `itboye_file` (`id`, `name`, `savename`, `savepath`, `ext`, `mime`, `size`, `md5`, `sha1`, `location`, `url`, `create_time`) VALUES
(1, 'boye_20150508_117189_all_sql.zip', '55667ac0bbae9.zip', '2015-05-28/', 'zip', 'application/zip', 50668, 'c8d8f0ef76575eec83ffa0c625768127', 'e13e95ec99828db246f90b99bbaaccea6980b276', 0, '', 1432779456);
...
--
-- 转存表中的数据 `itboye_picture`
--

INSERT INTO `itboye_picture` (`id`, `path`, `url`, `md5`, `sha1`, `status`, `createtime`) VALUES
...
INSERT INTO `itboye_post` (`id`, `post_author`, `post_date`, `post_content`, `post_title`, `post_category`, `post_excerpt`, `post_status`, `comment_status`, `post_modified`, `post_parent`, `comment_count`, `post_type`, `main_img`) VALUES
...
CREATE TABLE IF NOT EXISTS `itboye_ucenter_app` (
  ...
  `domain` varchar(128) NOT NULL DEFAULT '' COMMENT '绑定域名(128个字符以内)',
  `version` int(10) unsigned NOT NULL DEFAULT '1000' COMMENT '当前版本',
...
INSERT INTO `itboye_ucenter_app` (`id`, `app_id`, `title`, `url`, `ip`, `domain`, `version`, `auth_key`, `sys_login`, `allow_ip`, `create_time`, `update_time`, `status`) VALUES
(1, 'appid', 'OAuth2应用模块', 'http://127.0.0.1/', '127.0.0.1', 'itboye.com', 1004, 'hDE):a&XO"yF<V,>q}|L!nogZ~KfHWJ8MRQjY]7s', 1, '127.0.0.1', 0, 0, 1);
...
CREATE TABLE IF NOT EXISTS `itboye_upgrade_info` (
  ...
  `desc` text NOT NULL COMMENT '更新描述',
  `version` int(11) NOT NULL COMMENT '版本（例如：1）',
  `create_time` int(11) NOT NULL COMMENT '更新时间',
  `upgrade_pkg_url` varchar(256) NOT NULL COMMENT '更新包地址',
  `app_id` char(32) NOT NULL,
  `download_num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '下载量',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '0:未发布,1:正式发布',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='需要在线升级的程序历史表' AUTO_INCREMENT=1 ;
